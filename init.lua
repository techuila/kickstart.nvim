...
-- File Explorer
vim.keymap.set('n', '<leader>ox', vim.cmd.Ex)
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>nh', ':Telescope noice<CR>', { desc = '[N]oice Messages [H]istory' })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        typesscriptreact = { 'prettierd', 'prettier', stop_after_first = true },
